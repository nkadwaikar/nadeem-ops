...
| **Day 2** | Managed Identity + Azure Key Vault (Secretless Authentication) | 1.5h | [02-Managed-Identity-Key-Vault.md](./02-managed Identity + Azure Key Vault (Secretless Authentication).md) |
